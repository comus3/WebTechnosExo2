...
// Ajoutez quelques animaux initiaux
...
const averageAgeDiv = document.getElementById("averageAge");

function updateAverageAge() {
  ul.innerHTML = ""; // Efface la liste actuelle
...
typeInput.addEventListener("input", function () {
  typeValueOutput.textContent = typeInput.value === "1" ? "Chien" : "Chat";
});